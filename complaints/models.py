...
class Complaint(models.Model):
      ...
      complaint_category=models.CharField(max_length=20,roles=CATEGORY_CHOICES,default='road')
      complaint_image=models.ImageField(upload_to='complaint_images/')
      latitude=models.DecimalField(max_digits=10,decimal_places=7)
      longitude=models.DecimalField(max_digits=10,decimal_places=7)
      complaint_status=models.CharField(max_length=20,roles=STATUS_CHOICES,default='pending')
      complaint_priority=models.CharField(max_length=20,roles=PRIORITY_CHOICES,default='medum')
